        ...
        <>
          <ListItemButton
            ...
            sx={{
              ...
              ...(drawerOpen && {
                '&:hover': {
                  bgcolor: theme.palette.mode === ThemeMode.DARK ? 'rgba(255, 255, 255, 0.05)' : 'rgba(255, 255, 255, 0.05)'
                },
                '&.Mui-selected': {
          ...
          >
            {menuIcon && (
              ...
              sx={{
                ...
                '.Mui-selected &': {
                  color: drawerOpen ? 'white !important' : 'white'
                },
                ...(!drawerOpen && {
                  borderRadius: 1.5,
                  width: 36,
                  ...
                  color: 'white',
                  bgcolor: selected === menu.id ? theme.palette.mode === ThemeMode.DARK ? 'primary.900' : 'primary.lighter' : 'transparent',
                  '&:hover': {
                    color: iconSelectedColor,
            ...
            {(drawerOpen || (!drawerOpen && level !== 1)) &&
              (menu?.url ? (
                ...
                >
                  {miniMenuOpened || open ? (
                    <UpOutlined style={{ fontSize: '0.625rem', color: 'white' }} />
                  ) : (
                    <DownOutlined style={{ fontSize: '0.625rem', color: 'white' }} />
                  )}
                </IconButton>
              ) : (
                <>
