...
const FiltrosAndamentosMenu = ({ open, onClose, onFilter, initialFilters, origemOptions, tipoAndamentoOptions }) => {
      ...
      <LocalizationProvider dateAdapter={AdapterDateFns} adapterLocale={ptBR}>
        <Box sx={{ width: 650, p: 3 }}>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <InputLabel sx={{ fontSize: '12px', fontWeight: 600 }}>Tipo de Andamento</InputLabel>
              <FormControl fullWidth margin="normal">
                <Autocomplete
                  multiple
                  disableCloseOnSelect
          ...
          <Grid container spacing={2} marginTop={1}>
            <Grid item xs={6}>
              <InputLabel sx={{ fontSize: '12px', fontWeight: 600 }}>Data do Andamento - Início</InputLabel>
              <FormControl fullWidth margin="normal">
                <DatePicker
                  value={dtInicioDataAndamento}
                  onChange={(newValue) => setDtInicioDataAndamento(newValue)}
                  renderInput={(params) => <TextField {...params} />}
                />
              </FormControl>
            </Grid>
            <Grid item xs={6}>
              <InputLabel sx={{ fontSize: '12px', fontWeight: 600 }}>Data do Andamento - Fim</InputLabel>
              <FormControl fullWidth margin="normal">
                <DatePicker
                  value={dtFimDataAndamento}
                  onChange={(newValue) => setDtFimDataAndamento(newValue)}
                  renderInput={(params) => <TextField {...params} />}
                />
              </FormControl>
            </Grid>
