...
import { useGetMotivos } from "../../../api/motivos";
...
const ListagemMotivos = () => {
  ...
  const {
    ...
    isLoading,
    refetch,
  } = useGetMotivos(formData, processoSelecionadoId);
...
export default ListagemMotivos;
