...
function ColumnsLayouts() {
  ...
  const [titulo, setTitulo] = useState('Novo Produto');
...
{/* Nome, Código e Status na mesma linha */}
  ...
  <Grid item xs={2}>
    <Stack spacing={1}>
      ...
      <TextField
        ...
        placeholder="0000"
        value={codigo}
        sx={{ width: '130px' }} // Define largura aproximada de "3 dedos"
      />
    </Stack>
  </Grid>
...
<Grid item xs={8.5} sx={{ paddingBottom: 5 }}>
  <Stack spacing={1}>
    ...
    <TextField
      ...
      multiline
      rows={4}
      placeholder="Adicione uma descrição para esse motivo"
      value={descricao}
    />
  </Stack>
</Grid>
