...
function ColumnsLayouts() {
  ...
  const [nomeParte, setParte] = useState('');
  ...
  const [orgaoEmissorParte, setOrgaoEmissorParte] = useState('');
  ...
  const validarForm = () => {
    ...
    const newValidationState = {
      nomeParte: nomeParte.trim().length > 0,
    };
  ...
  const tratarSubmit = async () => {
    ...
    try {
      ...
      if (caracteresEspeciais.test(nomeParte)) {
      ...
      <Grid container spacing={1}>
        ...
        <Grid item xs={4} sx={{ paddingBottom: 5, marginRight: 5 }}>
          <Stack spacing={1}>
            ...
            <TextField
              ...
              placeholder="Nome"
              value={nomeParte}
              error={!nomeParte && formValidation.nomeParte === false}
            />
          </Stack>
        </Grid>
        ...
        <Grid item xs={6} sx={{ paddingBottom: 5 }}>
          <Stack spacing={1}>
            ...
            <TextField
              onChange={(event) => setTelefoneParte(event.target.value)}
              fullWidth
        ...
        <Grid item xs={6} sx={{ paddingBottom: 5 }}>
          <Stack spacing={1}>
            ...
            <TextField
              onChange={(event) => setNumeroParte(event.target.value)}
              fullWidth
        ...
        <Grid item xs={6} sx={{ paddingBottom: 5 }}>
          <Stack spacing={1}>
            ...
            <TextField
              onChange={(event) => setOrgaoEmissorParte(event.target.value)}
              fullWidth
              placeholder="Órgão"
              value={orgaoEmissorParte}
            />
          </Stack>
        </Grid>
