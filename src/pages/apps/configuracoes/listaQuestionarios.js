...
import ColumnsLayoutsDrawer from "./novoAcionistaDrawer";
import { enqueueSnackbar } from "notistack";
import AlertCustomerDelete from "../../../sections/apps/customer/AlertCustomerDelete";
import { useGetEmpresa } from "../../../api/questionarios";
...
const ListagemAcionistas = ({ normativaDados, onFilledQuestionarios }) => {
  ...
  useEffect(() => {
    ...
    emitter.on("refreshQuestionarios", refreshHandler);
    ...
    const baseColumns = [
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          const raw = row.original.statusQuiz;
          return (
            <Chip
              label={mapStatus[raw] ?? "Desconhecido"}
              size="small"
              sx={{
                backgroundColor: "transparent",
                color: "#00000099",
