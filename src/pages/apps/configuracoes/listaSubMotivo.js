...
import { useGetSubMotivo } from "../../../api/submotivo";
          ...
          <Stack direction="row" spacing={2} alignItems="center">
            ...
            >
              <Button
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  navigation(`/apps/processos/novo-submotivo`, {
                    state: { indoPara: "NovoSubMotivo" },
                  });
                }}
        ...
        <Stack>
          <Button
            ...
            onClick={() => {
              ...
              navigation(`/apps/processos/nova-acao-judicial`, {
                state: {
...
const ListagemSubMotivo = () => {
  ...
  const {
    ...
    isLoading,
    refetch,
  } = useGetSubMotivo(formData, processoSelecionadoId);
...
export default ListagemSubMotivo;
