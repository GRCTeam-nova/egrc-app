...
import { useGetColaboradores } from "../../../api/colaboradores";
          ...
          <Stack direction="row" spacing={2} alignItems="center">
            ...
            >
              <Button
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  navigation(`/colaboradores/criar`, {
...
function ActionCell({ row, refreshData }) {
  ...
  const toggleStatus = async () => {
    ...
    try {
      ...
      const getResponse = await axios.get(`https://api.egrc.homologacao.com.br/api/v1/action-plans/${idActionPlan}`, {
        headers: {
      ...
      await axios.put("https://api.egrc.homologacao.com.br/api/v1/action-plans", dadosAtualizados, {
        headers: {
          Authorization: `Bearer ${token}`,
...
const ListagemEmpresa = () => {
  ...
  const {
    ...
    isLoading,
    refetch,
  } = useGetColaboradores(formData, processoSelecionadoId);
