...
function ActionCell({ row, refreshData }) {
  ...
  const toggleStatus = async () => {
    ...
    try {
      ...
      const getResponse = await axios.get(`https://api.egrc.homologacao.com.br/api/v1/incidents/${idIncident}`, {
        headers: {
      ...
      await axios.put("https://api.egrc.homologacao.com.br/api/v1/incidents", dadosAtualizados, {
        headers: {
          Authorization: `Bearer ${token}`,
    ...
    >
      ...
      >
        ...
        <DialogContent>
          ...
          >
            Tem certeza que deseja inativar o incidente "{row.original.name}"?
          </Typography>
          <Typography
            component="div"
