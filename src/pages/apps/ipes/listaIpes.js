...
function ActionCell({ row, refreshData }) {
  ...
  const toggleStatus = async () => {
    ...
    try {
      ...
      const getResponse = await axios.get(`${process.env.REACT_APP_API_URL}ipe/${idInformationActivity}`, {
        headers: {
      ...
      await axios.put(`${process.env.REACT_APP_API_URL}ipe`, dadosAtualizados, {
        headers: {
          Authorization: `Bearer ${token}`,
