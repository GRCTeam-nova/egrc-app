...
function ActionCell({ row, refreshData }) {
  ...
  const toggleStatus = async () => {
    ...
    try {
      ...
      const getResponse = await axios.get(`${process.env.REACT_APP_API_URL}objective/${idObjective}`, {
        headers: {
      ...
      await axios.put(`${process.env.REACT_APP_API_URL}objective`, dadosAtualizados, {
        headers: {
          Authorization: `Bearer ${token}`,
